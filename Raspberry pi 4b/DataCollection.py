...
def main():
    ...
    try:
        while True:
            ...
            if Datacollect:
                feature= np.array([*euler1.split(','), *gyroscope1.split(','), *linear_accel1.split(','),
                                   *euler2.split(','), *gyroscope2.split(','), *linear_accel2.split(','), pot_value],dtype=float)
                data= np.vstack((data, feature))
                #print("COLLECTING..")
                print("{:03.3f}, {:03.3f}, {:03.3f}".format(euler1, euler2, pot_value))
