...
jingchenBC = np.loadtxt('jingchen_BC08.csv', delimiter=',')
qingBC = np.loadtxt('qing_BC08.csv', delimiter=',')
wangBC = np.loadtxt('wang_BC08.csv', delimiter=',')
zhouBC = np.loadtxt('zhou_BC08.csv', delimiter=',')

def view (data):
    data = np.hstack((data[:,3:9,],data[:,12:18]))
